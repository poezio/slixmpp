...
class XEP_0045(BasePlugin):
    ...
    async def destroy(self, room: JID, reason='', altroom='', ifrom=None) -> bool:
        ...
        try:
            ...
            log.debug('Unable to destroy room', exc_info=True)
            return False
        return True

    async def set_affiliation(self, room, jid=None, nick=None, affiliation='member', ifrom=None):
        ...
        try:
            ...
            log.debug('Unable to set affiliation', exc_info=True)
            return False
        return True
    ...
    async def set_role(self, room: JID, nick: str, role: str) -> bool:
        ...
        try:
            ...
            log.debug('Unable to set role', exc_info=True)
            return False
        return True
