...
class XEP_0030(BasePlugin):
    ...
    async def supports(self, jid=None, node=None, feature=None, local=False,
        ...
        data = {'feature': feature,
                'local': local,
                'cached': cached}
        return await self.api['supports'](jid, node, ifrom, data)

    async def has_identity(self, jid=None, node=None, category=None, itype=None,
        ...
        data = {'category': category,
                ...
                'local': local,
                'cached': cached}
        return await self.api['has_identity'](jid, node, ifrom, data)
