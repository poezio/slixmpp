...
# But it can introduce issues with specific usage of the stdlib, so let library
# users disable it if needed
if  getenv('SLIXMPP_DISABLE_DEFUSEDXML', default='false').lower() != 'true':
    try:
        import defusedxml
